! function(e) {
  ...
  function r(e, t, n, r) {
    ...
    return t && (l.id = t), n && n.forEach(e => l.classList.add(e)), r && (l.innerText = r), l
  }
  ...
  class i {
    constructor(e) {
      this.title = e, this.id = l(), this.tasks = []
    }
    render() {
      const e = r("div", this.id, ["folder"], null),
        t = r("p", null, null, this.title),
        n = r("img", null, ["delete"], null);
      n.src = "./img/delete.svg", n.addEventListener("click", () => {
        this.delete()
      }), e.appendChild(t), e.appendChild(n), d.appendChild(e), e.addEventListener("click", () => {
        a = this, a.active = !1, this.renderTasks(), document.querySelectorAll(".folder").forEach(e => e.classList.value = "folder"), document.querySelectorAll(".delete").forEach(e => e.src = "./img/delete.svg"), e.classList.value.includes("active") || (e.classList.add("active"), n.src = "./img/delete.svg")
      })
    }
    delete() {
      s = s.filter(e => e.id !== this.id), i.renderFolders()
    }
    renderTasks() {
      document.querySelector("#task-container").innerHTML = "", this.tasks.forEach(e => e.render())
    }
    static renderFolders() {
      d.innerHTML = "", s.forEach(e => e.render())
    }
    static setCurrentFolder(e) {
      a = e
    }
  }
  ...
  class u {
    constructor(e, t, n) {
      this.name = e, this.date = t, this.priority = n, this.id = l()
    }
    render() {
      ...
      u.src = "./img/edit.svg", u.addEventListener("click", () => {
        this.edit()
      }), t.appendChild(n), t.appendChild(l), d.appendChild(i), d.appendChild(s), d.appendChild(a), d.appendChild(u), e.appendChild(t), e.appendChild(d), o.appendChild(e), n.addEventListener("change", () => {
        l.classList.toggle("done")
      }), "urgent" === this.priority && s.classList.add("urgent"), a.addEventListener("click", () => {
        this.delete()
      })
    }
    delete() {
      a.tasks = a.tasks.filter(e => e.id !== this.id), a.renderTasks()
    }
    edit() {
